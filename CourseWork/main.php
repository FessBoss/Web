...
<body>
<a href="profile.php">Личный кабинет</a><br />
...
<center>
    ...
    echo '<th>Text</th>';
    echo '<th>Date</th>';
    if ($_SESSION['user'] && $_SESSION['user']['status'] != 'user') echo '<th>Изменить</th>';
    ...
    while($data = mysqli_fetch_array($query)){
        ...
        if ($_SESSION['user'] && $_SESSION['user']['status'] != 'user') echo '<td><A HREF=vendor/update.php?id=' . $data['id'] . '>Изменить</A></td>';
